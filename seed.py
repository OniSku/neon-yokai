...
ENEMIES: list[dict] = [
    ...
    },
    {
        ...
        "damage_type": "none",
        "ai_pattern": json.dumps([
            {"action": "apply_debuff", "apply_debuff": "VULNERABLE", "debuff_duration": 2},
            {"action": "attack", "damage": 4},
            {"action": "attack", "damage": 4},
            {"action": "apply_debuff", "apply_debuff": "WEAK", "debuff_duration": 2},
            {"action": "attack", "damage": 6},
            {"action": "apply_debuff", "apply_debuff": "VULNERABLE", "debuff_duration": 1},
            {"action": "apply_debuff", "apply_debuff": "WEAK", "debuff_duration": 1},
        ]),
    },
    # === BOSS ===
    {
